...
//					System.out.println("case2");
					Vector2 newN = getNormalInDirectionOf(p0p1.left(), c);
					adjust(p, newN);
...
//					System.out.println("case4");
					Vector2 newN = getNormalInDirectionOf(p1p2.left(), c);
					adjust(p, newN);
//					System.out.println(p.getNormal());
//					System.out.println(p.getDepth());
					return;
...
//					System.out.println("case1");
					Vector2 newN = getNormalInDirectionOf(p3p2.left(), c);
					adjust(p, newN);
//					System.out.println(p.getNormal());
//					System.out.println(p.getDepth());
					return;
...
//					System.out.println(p.getDepth());
	...
	private static final Vector2 getNormalInDirectionOf(Vector2 n, Vector2 p) {
		if (n.dot(p) > 0) {
			return n;
		} else {
	...
	private static final void adjust(Penetration p, Vector2 newNormal) {
		newNormal.normalize();
		double newD = p.getNormal().dot(newNormal) * p.getDepth();
		if (newD <= 0) {
			newD = p.getDepth();
		}
