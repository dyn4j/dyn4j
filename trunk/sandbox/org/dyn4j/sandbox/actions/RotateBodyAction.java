...
/**
 * Action to store information about rotating a body.
 * @author William Bittle
 * @version 1.0.0
 * @since 1.0.0
 */
public class RotateBodyAction extends Action {
	...
	/**
	 * Returns the begin position of the rotate body action in world coordinates.
	 * <p>
